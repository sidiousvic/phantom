module.exports = /******/ (function (modules) {
  ...
  /******/ /******/ return __webpack_require__(
    (__webpack_require__.s = "./src/phantom.ts")
  );
  /******/
})(
  /************************************************************************/
  ...
  \********************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _allowed__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          /*! ./allowed */ "./sanitizer/allowed.ts"
        );
        /*
 ...
 */
        ...
        function sanitizeNode(node) {
          ...
          if (
            !_allowed__WEBPACK_IMPORTED_MODULE_0__[
              "allowedTags"
          ...
          for (
            var nodeAttributes = 0;
            nodeAttributes < node.attributes.length;
            nodeAttributes++
          ) {
            var attributeName =
              (_a = node.attributes.item(nodeAttributes)) === null ||
              _a === void 0
                ? void 0
                : _a.name;
            if (
              _allowed__WEBPACK_IMPORTED_MODULE_0__["allowedTags"][
                nodeName
              ].hasOwnProperty(attributeName)
            ) {
              var sanitizer =
                _allowed__WEBPACK_IMPORTED_MODULE_0__["allowedTags"][nodeName][
                  attributeName
                ];
          ...
          for (var css in _allowed__WEBPACK_IMPORTED_MODULE_0__["allowedCSS"]) {
            sanitizedNode.style[
              _allowed__WEBPACK_IMPORTED_MODULE_0__["allowedCSS"][css]
            ] =
              node.style[
                _allowed__WEBPACK_IMPORTED_MODULE_0__["allowedCSS"][css]
              ];
  ...
  \************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        "use strict";
        __webpack_require__.r(__webpack_exports__);
        /* harmony import */ var _sanitizer_sanitizer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          /*! ../sanitizer/sanitizer */ "./sanitizer/sanitizer.ts"
        );
        var __values =
        ...
        function PHANTOM(reduxStore, XDOM) {
          ...
          function launchDOM() {
            ...
            try {
              ...
              throw new DOMException(
                "\uD83D\uDEABPotentially dangerous node, <" +
                  errorNode +
                  ">. Phantom has destroyed it. If you think this is a mistake, please raise an issue at: https://github.com/sidiousvic/phantom/issues"
              );
            }
          }
          ...
          function renderPseudoElement(pseudoElement) {
            ...
            if (pseudoElement === void 0) {
              pseudoElement = transmuteHTMLtoPseudoElement(
                coalescePhantomDOM()
              );
            }
            var tagName = pseudoElement.tagName,
              attributes = pseudoElement.attributes,
              innerHTML = pseudoElement.innerHTML,
              children = pseudoElement.children;
            var $children = [];
        ...
        */
            Object.values(pseudoDOM).map(function (pseudoDOMNode) {
              ...
              if (
                ...
                try {
                  for (
                    var _b = __values(Object.entries(attributes)),
                      _c = _b.next();
                    !_c.done;
                    _c = _b.next()
                  ) {
            ...
            */
                try {
                  newNode.innerHTML = Object(
                    _sanitizer_sanitizer__WEBPACK_IMPORTED_MODULE_0__["default"]
                  )(innerHTML);
